...
INSERT IGNORE INTO blog (slug_en, slug_es, title_en, title_es, meta_title_en, meta_title_es, meta_desc_en, meta_desc_es, excerpt_en, excerpt_es, content_en, content_es, status, published_at)
VALUES (
